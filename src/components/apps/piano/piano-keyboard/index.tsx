...
export default function PianoKeyboard({
  ...
  const getBlackKeyPosition = useCallback((blackKey: typeof blackKeys[0], whiteKeysList: typeof whiteKeys) => {
    ...
    const firstOctave = parseInt(whiteKeysList[0]?.fullNote.match(/\d+$/)?.[0] || '0', 10);
    ...
    if (noteName === 'C#') whiteKeyIndexInOctave = 0; // Between C and D
    else if (noteName === 'D#') whiteKeyIndexInOctave = 1; // Between D and E
    else if (noteName === 'F#') whiteKeyIndexInOctave = 3; // Between F and G
    else if (noteName === 'G#') whiteKeyIndexInOctave = 4; // Between G and A
    else if (noteName === 'A#') whiteKeyIndexInOctave = 5; // Between A and B
